...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 bg-lavender text-base-content">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p className="upercase">Little Possum Parties<br/>Providing reliable tech since 2011</p>
  </aside> 
